...
const CandyMachine = ({ walletAddress }) => {
  ...
  const getCandyMachineState = async () => {
    ...
    // IDL - info our web app needs to interact with candy machien
    // program - object we can use directly interact with the candy machine
    // -> essentially creating a connection to Solana like we would an API
    ...
    // getting minted NFTs to display
